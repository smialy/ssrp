...
def H(*a):  # a one-way hash function
    ...
    return int(hashlib.sha1(a.encode('ascii')).hexdigest(), 16)    
...
class Client():
    ...
    def process_challenge(self, salt, B):
        ...
        return H(self.A, B, self.K)

class Server():
    def __init__(self, I, salt, v, A, ng_type=NG_2048):
        print('*'*100)
        pr('I',I)
        pr('salt',salt)
        pr('v',v)
